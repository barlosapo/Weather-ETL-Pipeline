...
weather_pusher.py
-----------------
ETL pipeline: Davis Vantage Pro 2 -> WeatherLink HTML -> Supabase

Reads the HTML file generated by WeatherLink, parses current weather
conditions, and pushes them to a Supabase PostgreSQL backend.
...
label_map = {
    ...
    "Dewpoint":       "dewpoint",
    "Wind":           "wind",
    "10 Min Gust":    "wind_gust",
    "Barometer":      "barometer",
    "Today's Rain":   "rain_today",
    "Rain Rate":      "rain_rate",
    "Storm Total":    "rain_storm",
    "Monthly Rain":   "rain_monthly",
    "Yearly Rain":    "rain_yearly",
...
def parse_htm(path: str) -> dict:
    """
    Parse the WeatherLink HTML file and return a dict of field -> value.
    Values are returned as raw strings (units included) matching what
    the station outputs.
    """
...
def push_to_supabase(data: dict) -> None:
    """
    Upsert current conditions to weather_current (always row id=1)
    and append a new entry to weather_wind_log.
    """
